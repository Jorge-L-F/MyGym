        ...
        <v-card>
          ...
          <v-card-text>
            <v-container>
              ...
              <v-radio-group v-model="selectedMachine.isAvailable" row class="d-flex">
                <v-radio label="Available" :value="true"></v-radio>
                <v-radio label="Unavailable" :value="false"></v-radio>
              </v-radio-group>
            </v-container>
          </v-card-text>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="blue darken-1" text @click="selectedMachine = null">
              Cancel
            </v-btn>
...
export default {
  ...
  data() {
    return {
      ...
      typesOfMachines: ["Treadmill", "Bike", "Elliptical", "Rowing", "Other"],
